...
public class CentralUsers implements IUser {
    private double collections;
    private double  discounts;
    private TreeMap<String ,Integer> hMap;

    private Set<String> fromCentral;
    ...
    public boolean containsPassenger(String passenger){
        if(fromCentral.contains(passenger)) return true;
        return false;
    }

    public void addPassenger(String passenger){
        fromCentral.add(passenger);
    }

    public void removePassenger(String passenger){
        fromCentral.remove(passenger);
    }
